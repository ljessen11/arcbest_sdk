...
class Commodity:
    def __init__(self,
                 ...
                 nmfc_number: int | None = None,
                 nmfc_sub_number: int | None = None,
                 cube: float | None = None,
                 description: str | None = None,
                 hazmat: bool | None = None,
                 hazmat_class: int | None = None,
                 un_ua_number: int | None = None,
                 hazmat_contact_name: str | None = None,
                 hazmat_contact_phone: str | None = None,
                 hazmat_contact_phone_ext: str | None = None,
                 hazmat_proper_shipping_name: str | None = None,
                 hazmat_technical_name: str | None = None,
                 hazmat_product_name: str | None = None,
                 hazmat_sub_hazard1: str | None = None,
                 hazmat_sub_hazard2: str | None = None,
                 hazmat_packaging_group: str | None = None,
                 hazmat_additional_info: str | None = None,
                 hazmat_dot_exemption: str | None = None,
                 hazmat_special_permit: str | None = None,
                 hazmat_reportable_quantity: bool | None = None,
                 hazmat_limited_quantity: bool | None = None,
                 hazmat_poison_inhalation_hazard: bool | None = None,
                 hazmat_bulk_package: bool | None = None,
                 hazmat_marine_pollutant: bool | None = None,
                 hazmat_residue_last_contained: bool | None = None,
                 hazmat_compatibility: HazMatCompatibilities | None = None,
                 hazmat_material_zone: HazMatZones | None = None,
                 hazmat_flash_point_temp: float | None = None,
                 hazmat_net_explosive_mass: float | None = None):
